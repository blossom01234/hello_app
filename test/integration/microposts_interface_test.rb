...
class MicropostsInterfaceTest < MicropostsInterface
  test "shouold paginate microposts" do
    get root_path
  ...
  test "should create a micropost on submission" do
  ...
  test "shouold not have delete link on other user's profile page" do
...
class ImageUploadTest < MicropostsInterface
  test "should have a file inpu field for images" do
    get root_path
